...
def parse(dest, month, date):
	for i in range(5):
		try:
			url = "https://www.expedia.com/Flights-Search?trip=oneway&leg1=from%3Akuala%20lumpur%2Cto%3A{0}%2Cdeparture%3A{1}%2F{2}%2F2019TANYT&passengers=adults%3A1%2Cchildren%3A0%2Cseniors%3A0%2Cinfantinlap%3AY&options=cabinclass%3Aeconomy&mode=search&origref=www.expedia.com#outbound".format(dest, month, date)
			headers = {'User-Agent': 'Chrome/74.0.3729.169 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Mozilla/5.0 Safari/537.36'}
